    ...
    <div class="flex flex-col items-center w-full h-[36rem]">
      <TabGroup>
        <TabList :class="['flex flex-row space-x-1 divide-x-2 rounded-xl w-full h-full p-1']">
          <div
            class="w-1/5 h-full flex flex-col justify-items-start rounded-md p-2 bg-slate-400/20"
          >
            <div class="w-full h-32">
              <h2
                class="max-w-lg text-[1.6rem]/10 font-medium tracking-tighter text-balance max-sm:px-4 2xl:mt-0"
              >
                账户设置
              </h2>
              <span class="font-normal"> 在这里可以查看和修改您的个人信息，以及您的账号信息 </span>
            </div>
            <Tab
