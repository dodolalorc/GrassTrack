<template>
  <div class="w-full min-h-full text-3xl flex flex-col py-20 bg-white/90 rounded-xl">
    <h1 class="text-center text-4xl font-bold mb-10">牲畜管理</h1>
      ...
      >
        ...
        <el-table-column fixed="right" label="操作" min-width="120">
          <template #default="scope">
            <el-button link type="primary" @click="updateAnimalTypeInfo(scope.$index)"
              >修改信息</el-button
            >
          </template>
        </el-table-column>
  ...
  <AddAnimalDialog
    ...
    v-model:animal-info="currentAnimalInfo"
    v-model:animal-type-list="animalTypeList"
