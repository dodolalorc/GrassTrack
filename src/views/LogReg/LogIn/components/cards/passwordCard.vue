<template>
  <el-form ref="loginRef" :model="ruleForm" :rules="rules" label-width="auto" label-position="top" class="px-2 py-5">
    ...
    <div class="flex w-full mb-6 justify-end">
      <button class="text-right rounded-md text-blue-800 text-sm underline" type="button" link @click="forgetPwd">
        忘记密码?
      </button>
    </div>
    <div class="mt-3 flex flex-col items-center">
      <button
        ...
        :disabled="ruleForm.username === '' || ruleForm.password === ''" @click="submitForm">立即登录</button>
